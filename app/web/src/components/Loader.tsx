...
export function Loader_line() {
    return (
        <div className="flex items-center justify-center py-10">
            <div className="loader-line" role="status" aria-live="polite">
                <span className="loader-line__dots" aria-hidden="true">
                    <i></i>
                    <i></i>
                    <i></i>
                </span>
                <span className="loader-line__text">กำลังโหลด</span>
            </div>
        </div>
    );
}

export function buntton_Logout() {
    return (
        <button className="Btn">
            <div className="sign"><svg viewBox="0 0 512 512">
                <path d="M377.9 105.9L500.7 228.7c7.2 7.2 11.3 17.1 11.3 27.3s-4.1 20.1-11.3 27.3L377.9
                 ...
                 0-32-14.3-32-32l0-64c0-17.7 14.3-32 32-32l128 0 0-62.1c0-18.7 15.2-33.9 33.9-33.9c9 0 
                 ...
                 32 32s-14.3 32-32 32z"></path></svg></div>
